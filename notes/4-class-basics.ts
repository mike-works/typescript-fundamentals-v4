...
const c1 = new Contact('Mike', 'mike@mike.works');
// @ts-expect-error
const c2 = new Contact('Mike', 555555);

export class OtherContact implements HasEmail {
    email: string = '';
    name: string = '';
}
 ...
 */
 ...
 export class Contact2 implements HasEmail {
